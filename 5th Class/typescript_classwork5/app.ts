...
let fruits: (string | number)[] = ["apple", "mango", "banna", "orange"];
fruits.push(1)
// console.log(fruits);

let colours: string[] = ["red", "blue", "green", "yellow"];
...
let cars: string[] = ["Honda", "BMW", "Toyota", "Mercedes"];
const car = cars.slice(1, 3)
// console.log(car);

function add(num1: number, num2 = 4) {
    return num1 + num2;
}
add(2);
