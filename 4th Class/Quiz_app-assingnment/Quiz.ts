...
const user_Ans1 :string =prompt(`${questions[0]}\nA.Earth\nB.Jupiter\nC.Mars\n`) || "";

if(user_Ans1.toLowerCase()===Answer[0].toLowerCase()){
    points +=25  
}

const user_Ans2 :string =prompt(`${questions[1]}\nA.Karachi\nB.New York\nC.Canberra\n`) || "";
if(user_Ans2.toLowerCase()===Answer[1].toLowerCase()){
    points +=25  
}

const user_Ans3 :string =prompt(`${questions[2]}\nA.Kilimanjaro\nB.Mount Elgon\nC.Mount Kenya\n`) || "";
if(user_Ans3.toLowerCase()===Answer[2].toLowerCase()){
    points +=25  
}

const user_Ans4 :string =prompt(`${questions[3]}\nA.(J.K.)Rowling\nB.Harper Lee\nC.Jane Austen\n`) || "";
